...
function render(data) {
 ...
 $('graph-status').textContent=h.status==='verified'?`The Graph: pool state checked at block ${h.blockNumber}. ${h.graphHashVerified===false?'Block hash not provided; not eligible for execution. ':''}${h.note}`:h.message;
